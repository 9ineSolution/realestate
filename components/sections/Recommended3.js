				...
				<div className="container">
					...
					<div className="flat-tab-recommended">
						...
						<div className="tab-content">
							<div className={isTab == 1 ? "tab-pane fade show active" : "tab-pane fade"} id="viewAll" role="tabpanel">
								<div className="row">
							...
							<div className={isTab == 2 ? "tab-pane fade show active" : "tab-pane fade"} id="apartment" role="tabpanel">
								<div className="row">
									<div className="col-xl-4 col-lg-6 col-md-6">
										<div className="homeya-box">
											<div className="archive-top">
							...
							<div className={isTab == 3 ? "tab-pane fade show active" : "tab-pane fade"} id="villa" role="tabpanel">
								<div className="row">
									<div className="col-xl-4 col-lg-6 col-md-6">
										<div className="homeya-box">
											<div className="archive-top">
							...
							<div className={isTab == 4 ? "tab-pane fade show active" : "tab-pane fade"} id="studio" role="tabpanel">
								<div className="row">
									<div className="col-xl-4 col-lg-6 col-md-6">
										<div className="homeya-box">
											<div className="archive-top">
							...
							<div className={isTab == 5 ? "tab-pane fade show active" : "tab-pane fade"} id="house" role="tabpanel">
								<div className="row">
									<div className="col-xl-4 col-lg-6 col-md-6">
										<div className="homeya-box">
											<div className="archive-top">
							...
							<div className={isTab == 6 ? "tab-pane fade show active" : "tab-pane fade"} id="office" role="tabpanel">
								<div className="row">
									<div className="col-xl-4 col-lg-6 col-md-6">
										<div className="homeya-box">
											<div className="archive-top">

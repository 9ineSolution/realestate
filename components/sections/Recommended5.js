...
export default function Recommended5() {
	return (
		<>
			...
			<section className="flat-section flat-recommended wow fadeInUpSmall" data-wow-delay=".2s" data-wow-duration="2000ms">
							...
							<div className="homeya-box md style-2">
								<div className="archive-top">
									...
									<div className="content">
										...
										<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>15 Willow Street, Seattle, WA</p> </div>
						...
						<div className="col-xl-3 col-md-6">
							<div className="homeya-box md style-2">
								<div className="archive-top">
									...
									<div className="content">
										<div className="text-1 text-capitalize"><Link href="/property-details-v1" className="link">Villa del Mar Retreat</Link></div>
										<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>22 Pine Avenue, San Francisco, CA</p> </div>
										<ul className="meta-list">
											<li className="item">
												<i className="icon icon-bed" />
												<span>3</span>
							...
							<div className="homeya-box md style-2">
								<div className="archive-top">
									...
									<div className="content">
										...
										<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>5 Magnolia Drive, Miami, FL</p> </div>
										<ul className="meta-list">
											<li className="item">
												<i className="icon icon-bed" />
												<span>4</span>
							...
							<div className="homeya-box md style-2">
								<div className="archive-top">
									...
									<div className="content">
										...
										<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>10 Oakwood Lane, Chicago, IL</p> </div>
										<ul className="meta-list">
											<li className="item">
												<i className="icon icon-bed" />
												<span>3</span>
							...
							<div className="homeya-box md style-2">
								<div className="archive-top">
									...
									<div className="content">
										...
										<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>25 Elm Street, Portland, OR</p> </div>
										<ul className="meta-list">
											<li className="item">
												<i className="icon icon-bed" />
												<span>4</span>
							...
							<div className="homeya-box md style-2">
								<div className="archive-top">
									...
									<div className="content">
										...
										<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>12 Spruce Avenue, Denver, CO</p> </div>
										<ul className="meta-list">
											<li className="item">
												<i className="icon icon-bed" />
												<span>2</span>
						...
						<div className="col-xl-3 col-md-6">
							<div className="homeya-box md style-2">
								<div className="archive-top">
									...
									<div className="content">
										<div className="text-1 text-capitalize"><Link href="/property-details-v1" className="link">Mountain Mist Retreat, Aspen</Link></div>
										<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>7 Cedar Street, Austin, TX</p> </div>
										<ul className="meta-list">
											<li className="item">
												<i className="icon icon-bed" />
												<span>2</span>
						...
						<div className="col-xl-3 col-md-6">
							<div className="homeya-box md style-2">
								<div className="archive-top">
									...
									<div className="content">
										<div className="text-1 text-capitalize"><Link href="/property-details-v1" className="link">Seaside Bliss Residence</Link></div>
										<div className="desc"><i className="fs-16 icon icon-mapPin" /><p>15 Willow Street, Seattle, WA</p> </div>
										<ul className="meta-list">
											<li className="item">
												<i className="icon icon-bed" />
